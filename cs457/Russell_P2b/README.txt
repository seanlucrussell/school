...
The web crawler prints all the urls it finds to standard out, so if you want you can send the output to a file, ie
   go run src/part2/cmd/crawler/crawler.go -u="http://www.cs.colostate.edu" -d=3 >> output.txt