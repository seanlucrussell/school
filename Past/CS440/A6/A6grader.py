...
if False:
    ...
    import A6mysolution as useThisCode
elif False:
    runningInNotebook = False
    ...
    runningInNotebook = True

if not runningInNotebook:
    trainNNs = useThisCode.trainNNs
    summarize = useThisCode.summarize
    bestNetwork = useThisCode.bestNetwork
