...
public class Maze {
    ...
    public boolean checkRight() {
        ...
        // Legal move?
    	return ((currCol + 1 < mazeWidth) &&
                (mazeData[currRow][currCol + 1] != 'D'));
    }
    ...
    public boolean checkDown() {
        ...
        // Legal move?
    	return ((currRow + 1 < mazeHeight) &&
                (mazeData[currRow + 1][currCol] != 'D'));
    }
    ...
    // Error exit
    public void errorExit(int row, int col) {
    
    	if (col < 0)
    		System.out.print("Exited maze left,");
    	else if (col >= mazeWidth)
    		System.out.print("Exited maze right,");
    	if (row < 0)
    		System.out.print("Exited maze top,");
    	else if (row >= mazeHeight)
    		System.out.print("Exited maze bottom,");
    	else if (mazeData[row][col] == 'D') {
    		System.out.print("Ran into obstacle,");
    	}
