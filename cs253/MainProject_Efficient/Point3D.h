...
public:
  ...
  void scale(const double scale);			//!< Vector scale the point by some scalar
  void transform(const double xTransform, const double yTransform, const double zTransform);
